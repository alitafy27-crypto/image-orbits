...
const faqs = [
  {
    question: "Is My Site completely free?",
    answer:
  ...
  },
  {
    ...
    answer:
      "My Site supports PNG, JPG, JPEG, WEBP and AVIF, with more formats coming soon.",
  },
  {
  ...
  {
    question: "Does My Site work on mobile devices?",
    answer:
  ...
  return (
    <Section className="bg-white">
      <Heading
        ...
        description="Everything you need to know about My Site."
      />
